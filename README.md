...
<h3><b>License:</b></h3>
The license for this project can be found in the LICENSE file of the root file directory. The Licence is authourised by <a href='https://choosealicense.com/licenses/mit/' alt=MIT>
